				...
				<Disclosure>
					{({ open }) => (
						<>
							...
							<Disclosure.Panel className="px-4 pt-4 pb-2 text-gray-500 text-base max-h-96 overflow-y-auto my-2">
								{/* {source} */}
								<ReactMarkdown components={ChakraUIRenderer()} children={description} skipHtml />
							</Disclosure.Panel>
						</>
					)}
				</Disclosure>
